...
// Add Events to Board //
/////////////////////////
Wordblocks.prototype.disableEvents = function disableEvents() { if (this.browser_active == 1) { $('.slot').off(); } }
Wordblocks.prototype.enableEvents = function enableEvents() { if (this.browser_active == 1) { this.addEventsToBoard(); } }
