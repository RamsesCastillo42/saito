...
console.log("VALIDATING: " + this.transaction.id);
  ...
  ////////////////////////////
console.log("VALIDATE TRANSACTION INCLUDES: " + JSON.stringify(this.transaction.from) + " -- " + app.blockchain.returnLatestBlockId());
