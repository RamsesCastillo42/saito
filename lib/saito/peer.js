...
console.log("NOT SENDING HANDSHAKE!");
  }
  //this.addSocketEvents();
  //this.sendHandshake();
...
console.log("SENDING REQUEST WITH HANDSHAKE");
 ...
 */
Peer.prototype.addSocketEvents = async function addSocketEvents() {
...
console.log("RECEIVED HANDSHAKE INITIALLY");
...
console.log("\nBLOCK\n");
          ...
          if (this.app.blockchain.isHashIndexed(hash) != 1) {
            if (txsno == 0) {
              if (this.app.BROWSER == 1) {
                ...
                await this.app.mempool.fetchBlock(this, hash);
              }
            } else {
              await this.app.mempool.fetchBlock(this, hash);
            }
      ...
      // dns //
      /////////
      if (message.request == "dns multiple") {
...
console.log("SENDING THE BLOCKCHAIN!");
