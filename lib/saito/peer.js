...
if (app.BROWSER == 1) { console.log("DEBUGGING PERSISTENT ERROR: -- offchain loop"); }
...
if (this.app.BROWSER == 0) { console.log("RECEIVING BLOCKCHAIN : " + blocks.prehash.length); }
...
if (this.app.BROWSER == 0) { console.log("RECEIVED BLOCKCHAIN! persistent error debugging"); }
...
if (this.app.BROWSER == 0) { console.log("SENDING BLOCKCHAIN PERSISTENT ERROR: -- " + this.app.blockchain.index.bid[i] + " -- " + start_bid); }
...
if (this.app.BROWSER == 0) { console.log("SENDING BLOCKCHAIN PERSISTENT ERROR 2: -- "); }
 ...
 * Adds the path to TX
 */
Peer.prototype.addPathToTransaction = function addPathToTransaction(tx) {
  var tmptx = new saito.transaction();
  tmptx.transaction = Object.assign({}, tx.transaction);
