 ...
 *
 * @param {string} publickey
 * @param {string} proxymod_host
 * @param {string} proxymod_port
 * @param {string} proxymod_publickey
 */
Keychain.prototype.updateProxyByPublicKey = function updateProxyByPublicKey(publickey, proxy_host = "", proxy_port = "", proxy_publickey = "") {
 ...
 * @param {string} proxymod_publickey
 */
Keychain.prototype.returnProxyByPublicKey = function returnProxyByPublicKey(publickey) {
