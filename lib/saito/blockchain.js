...
console.log("A: " + this.app.options.blockchain.fork_id);
          return this.app.options.blockchain.fork_id;
        }
      }
    }
  }
console.log("B: " + this.fork_id);
  return this.fork_id;
}
...
console.log("UPDATE FORK ID: " + newblock.block.id + " -- " + this.fork_id_mod);
