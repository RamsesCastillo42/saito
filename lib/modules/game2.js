...
console.log("NEW DECK: " + JSON.stringify(game_self.game.deck.cards));
...
console.log("PLAINTEXT: ");
    	      let a = 0; for (var i in game_self.game.cards) { 
console.log(i);
game_self.game.deck.cards[a] = game_self.app.crypto.stringToHex(i); a++; }
console.log("HEX --> " + JSON.stringify(game_self.game.deck.cards));
              game_self.game.queue.splice(gqe, 1);
...
console.log("\n\n\nI AM XORRING WTH: " + game_self.game.deck.xor);
...
console.log("I AM SENDING XORRED CARDS TO OPPONENT");
...
console.log("C");
  if (mycallback != null) { 
console.log("ROLLDICE 1: callback");
    mycallback((a + 1)); 
  } else { 
console.log("ROLLDICE 2: a+1");
    return (a + 1); 
  }
}
