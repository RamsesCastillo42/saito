...
Mods.prototype.pre_initialize = function pre_initialize() {
  ...
  // this.mods.push(require('./mods/scrabble/scrabble')(this.app));
  this.mods.push(require('./mods/chess/chess')(this.app));
  //this.mods.push(require('./mods/arcade/arcade')(this.app));
  this.mods.push(require('./mods/chatcade/arcade')(this.app));
...
console.log("IS: " + this.mods[imp].name + " active? " + this.mods[imp].browser_active);
    if (this.mods[imp].browser_active == 1) {
console.log("PRE ATTACHING EVENTS !");
      this.mods[imp].attachEvents(this.app);
console.log("DNE ATTACHING EVENTS !");
    }
  }
  return null;
}
