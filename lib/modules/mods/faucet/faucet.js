...
Faucet.prototype.webServer = function webServer(app, expressapp) {
  ...
  expressapp.get('/faucet/', function (req, res) {
    ...
    if (req.query.source_domain != null) {
      source_domain = req.get('hostname');
    } else {
      source_domain = req.headers.source_domain;
    }
    ...
    if (req.query.source_protocol != null) {
      source_protocol = req.query.source_protocol;
    }
