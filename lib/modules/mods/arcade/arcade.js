...
Arcade.prototype.returnGameMonitor = function returnGameMonitor(app) {
  ...
  return `
    ...
    <div class="funding_alert">
      Transfer tokens to this address or <a href="/faucet?saito_address=${app.wallet.returnPublicKey()}&source_domain=localhost&source_port=12101&source_protocol=http&source_app=arcade" target="_new">fund this address from the main faucet</a>.
    </div>
...
<br />
        <div style="display:inline;cursor:pointer;float:left;" id="invite_button" class="invite_button">invite</div>
      </div>
