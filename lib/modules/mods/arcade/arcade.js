...
Arcade.prototype.returnGameMonitor = function returnGameMonitor(app) {
  ...
  return `
    ...
    <div class="funding_alert">
      Transfer tokens to this address or <a href="https://games.saito.network/faucet?saito_address=${app.wallet.returnPublicKey()}&source_domain=games.saito.network&source_protocol=https&source_app=arcade" target="_new">fund this address from the main faucet</a>.
    </div>
