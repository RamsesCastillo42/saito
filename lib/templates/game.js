...
console.log("DECRYPTING: " + nc + " with this key " + thiskey);
	  nc = game_self.app.crypto.decodeXOR(nc, thiskey);
console.log("the result is: " + nc);
...
console.log("HOW MANY KEYS VS NEEDED: " + game_self.game.pool[poolidx-1].keys[cryptidx].length + " -- " + decryption_keys_needed);
...
console.log("CRYpTO LEN: " + game_self.game.deck[deckidx-1].crypt.length);
console.log("CRYpTO KEY: " + game_self.game.deck[deckidx-1].keys.length);
...
console.log(game_self.game.deck[deckidx-1].crypt[i]);
