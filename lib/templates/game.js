...
console.log("NEW GAME ID : " + game_id);
	  ...
	  if (txmsg.ts > 0) {
	    ...
	    if (game_self.app.crypto.verifyMessage(invite_ts, invite_sig, game_self.app.wallet.returnPublicKey()) == 1) {
console.log("WE ARE AUTO-ACCEPTING THIS INVITATION AS WE SIGNED IT....");
	      ...
	      //
	      var newtx = game_self.app.wallet.createUnsignedTransactionWithDefaultFee(tmpar[0], 0.0);
