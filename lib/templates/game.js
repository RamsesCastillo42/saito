...
console.log("about to verify message signed by me? " + game_self.app.wallet.returnPublicKey());
console.log(game_self.app.wallet.signMessage(invite_sig.toString(), game_self.app.wallet.returnPrivateKey()) + " <--- SIG WE WOULD GENERATE!");

	    if (game_self.app.crypto.verifyMessage(invite_ts.toString(), invite_sig.toString(), game_self.app.wallet.returnPublicKey()) == 1) {

console.log("SIG VERIFIES!");
...
console.log("SIG VERIFIES 2!");

	      if (already_accepted_invite == 1) {
console.log("SIG VERIFIES 3!");
		return;
	      } else {
console.log("SIG VERIFIES 4!");
