...
console.log("WHAT IS HTE SIG: " + txmsg.sig);
...
console.log("WE ARE AUTO-ACCEPTING THIS INVITATION AS WE SIGNED IT.... 2");
...
console.log("WE ARE AUTO-ACCEPTING THIS INVITATION AS WE SIGNED IT.... 3");
...
console.log("WE ARE AUTO-ACCEPTING THIS INVITATION AS WE SIGNED IT.... 4");

	      newtx = game_self.app.wallet.signTransaction(newtx);
	      game_self.app.network.propagateTransaction(newtx);

console.log("WE ARE AUTO-ACCEPTING THIS INVITATION AS WE SIGNED IT.... 5");
...
console.log("PARANOID REVERSION OF OLD ID: " + old_game_id);
