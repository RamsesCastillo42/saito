...
//    try {
	...
	if (txmsg.game_id != "") { game_self.loadGame(txmsg.game_id); }
...
console.log("gs: " + JSON.stringify(game_self.game));
...
console.log("THIS IS OUR GAME SUBMITTED");
    this.app.options.games.push(this.game);
  } else {
console.log("NEW GAME CREATED IN SAVE");
    this.game = this.newGame(game_id);
  }
...
console.log("REMOTE ADDRESS 2: " + remote_address);
      }
