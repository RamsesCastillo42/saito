...
Game.prototype.initializeHTML = function initializeHTML(app) {
  ...
  //add counter
  const countdown = app.modules.returnModule("Countdown");
...
console.log(game_self.game.queue.length + " <---  queue");
console.log(game_self.game.queue);
	...
	this.updateStatus("Requestion decryption keys to draw cards from deck...");
